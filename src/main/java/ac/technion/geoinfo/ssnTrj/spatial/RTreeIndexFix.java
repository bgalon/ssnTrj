...
import org.neo4j.gis.spatial.SpatialIndexVisitor;
import org.neo4j.gis.spatial.SpatialIndexWriter;
import org.neo4j.gis.spatial.SpatialRelationshipTypes;
import org.neo4j.gis.spatial.SpatialTreeIndex;
//import org.neo4j.gis.spatial.RTreeIndex.IndexNodeToGeometryNodeIterable;
//import org.neo4j.gis.spatial.RTreeIndex.RecordCounter;
//import org.neo4j.gis.spatial.RTreeIndex.WarmUpVisitor;
//import org.neo4j.gis.spatial.RTreeIndex.IndexNodeToGeometryNodeIterable.GeometryNodeIterator;
 ...
 */
public class RTreeIndexFix implements SpatialTreeIndex, SpatialIndexWriter, Constants {

	// Constructor
	
	public RTreeIndexFix(GraphDatabaseService database, Layer layer) {
		this(database, layer, 100, 51);
	}
	
	public RTreeIndexFix(GraphDatabaseService database, Layer layer, int maxNodeReferences, int minNodeReferences) {
